...
namespace DnDApi.Migrations
{
    ...
    [Migration("20220826132021_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DnDApi.Database.Maintenance", b =>
                {
                    ...
                    b.Property<double?>("RecordedKm")
                        .HasColumnType("float")
                        .HasColumnName("RecordedKM");
            ...
            modelBuilder.Entity("DnDApi.Database.Setting", b =>
                {
            ...
            modelBuilder.Entity("DnDApi.Database.Incident", b =>
                {
                    b.HasOne("DnDApi.Database.DateTimeDriverVehicle", "DateTimeDriverVehicles")
                        .WithMany("Incidents")
                        .HasForeignKey("DateTimeDriverId")
